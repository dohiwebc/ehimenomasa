...
def fill_about():
    ...
    body = {
        ...
        "body": p_tags(
            ...
            "それから4年後の平成25年3月3日にお店を【株式会社 雅道】に法人化し、現在に至ります。",
...
def fill_access():
    ...
    body = {
        ...
        "phone": "089-913-1194",
        "holiday": "日曜日・祝日",
        "hours": "17:30～23:00（ラストオーダー 22:30）",
        "accessText": (
            "【電車・バスでお越しの方へ】\n"
            "伊予鉄・松山市駅より徒歩1分。松山市駅・北側出口を出て、すぐの横断歩道を渡りきると正面にございます。"
        ...
        "seatInfo": "松山市駅前の小さな居酒屋。健勝ビル2階。カウンターとテーブルで、仕事帰りから宴会まで。",
        "mapEmbed": (
...
def fill_site():
    ...
    body = {
        ...
        "recruitBody": p_tags(
            ...
            "勤務地：愛媛の雅ちゃん（〒790-0012 愛媛県松山市湊町5丁目4-2 健勝ビル2F）。伊予鉄「松山市駅」より徒歩30秒。転勤なし。",
